...
class ProUser extends User 
{
    ...
    public function __construct($username,$email, $password, $adresse, $date_start_subscription , $date_end_subscription ,$bio, $role = 'ProUser')
    {
        parent::__construct($username,$email, $password, $adresse, $bio, $role);
        $this->date_start_subscription = date('Y-m-d H:i:s');
        $this->date_end_subscription = date('Y-m-d H:i:s');
    }
